    ...
    if (document.getElementById(event.target.id).classList.contains('match')) {
        ...
        if (cardIconA === cardIconB) {
            ...
            if (matches === 8) {
                ...
                document.getElementById('modalContent').innerHTML = "<p>Congratualtions you win!</p><p>It took you " + gameTime + " seconds.<br>You did it in " + moves + " moves and earned a star rating of " + stars + ".</p><p>Click this window to play again!</p>";
